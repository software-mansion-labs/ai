...
There is no official industry standard for spec files. However, during my experiments with SDD, I ended up using requirement tables as tooling and human friendly specification files.
